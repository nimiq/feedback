...
export default {
  ...
  feedbackWidget: {
    ...
    termsAndConditionsApply: 'Termos e condições se aplicam',
  },
  formContainer: {
    ...
    consentTermsAndFeedback: 'Concordo com os Termos de Serviço e uso do meu feedback para melhorar os produtos Nimiq',
